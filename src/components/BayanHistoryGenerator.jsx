  ...
  const generateHistory = async () => {
    ...
    try {
      ...
      if (!apiKey || apiKey === 'your_gemini_api_key_here') {
        throw new Error('Ключ не найден! Если ты добавил ключ в .env только что, ТЕБЕ НУЖНО ПЕРЕЗАПУСТИТЬ ЛОКАЛЬНЫЙ СЕРВЕР (закрой консоль или нажми Ctrl+C, а затем снова пропиши npm run dev). Vite не читает .env на ходу!');
      }
